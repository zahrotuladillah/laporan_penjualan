...
public class DataService {
    ...
    public List<Map<String, Object>> getRangkuman() {
        String query = "SELECT tl.tl_nama AS Nama, SUM(sj.sj_total_harga) * tl.tl_laba / 100 * 12 AS \"LabaTahunan\" " +
    ...
    public List<Map<String, Object>> getDetail() {
        String query = "SELECT temp.nama AS \"NamaProduk\", temp.harga AS \"HargaProduk\", " +
                "SUM(k_jumlah) AS \"Jumlah\", SUM(k_subtotal) AS \"Subtotal\", " +
                "temp2.nama AS \"Pemesan\", temp2.tl_laba*SUM(k_subtotal)/100+SUM(k_subtotal) AS \"PenghasilanKotor\", " +
